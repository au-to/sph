      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @chenge="chengeSkuNum"/>
...
export default {
  ...
  async addShopCar() {
    try {
      await this.$store.dispatch('addOrUpdateShorpCart',{skuId:this.$route.params.skuId,skuNum:this.skuNum});
      // 会话存储存储数据
